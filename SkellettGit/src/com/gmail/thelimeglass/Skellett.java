...
public class Skellett extends JavaPlugin {
	...
	public void onEnable(){
		...
		if (config.getBoolean("PluginHooks.Npc")) {
			...
			Skript.registerEvent("[on] (npc|citizen) despawn:", SimpleEvent.class, NPCDespawnEvent.class, "[on] (npc|citizen) despawn");
	...
	private void register() throws IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
		...
		Bukkit.getConsoleSender().sendMessage(Skellett.cc(Skellett.prefix + "Registered &a" + effN + " &eEffects, &a" + condN + "&e Conditions and &a" + exprN + "&e Expressions"));
	}
}
/*
New Stuff:
