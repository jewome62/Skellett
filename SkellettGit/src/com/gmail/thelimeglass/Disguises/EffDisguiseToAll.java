...
@Syntax("[skellett] [[Libs]Disguises] [set] Disguise [of] %entity% (as|to) %string% [with block [id] %-integer%] [(and|with) data [id] %-integer%] [with [user[ ]]name %-string%] [(and|with) baby [state] %-boolean%]")
